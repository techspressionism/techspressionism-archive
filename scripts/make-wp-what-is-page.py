...
PAGE = f"{SITE}/what-is-techspressionism/"
...
FAQ = [
    ...
    ("Who founded the Techspressionist community?",
     "In August 2020 Goldberg and Oz Van Rosen set out to form an artist group, starting on Instagram. The website launched on August 22, 2020, together with the "
     "artist Steve Miller, and the first Techspressionist Virtual Salon took place on Zoom on September 1, 2020, with Helen Harrison as advisor and the artist "
     "and theorist Patrick Lichty joining. That “core group” agreed on the current definition that day and effectively became the founders of the movement.",
     "In August 2020 Goldberg and Oz Van Rosen set out to form an artist group, starting on Instagram. The website launched on August 22, 2020, together with the "
     "artist Steve Miller, and the first Techspressionist Virtual Salon took place on Zoom on September 1, 2020, with Helen Harrison as advisor and the artist "
     "and theorist Patrick Lichty joining. That core group agreed on the current definition that day and effectively became the founders of the movement."),
...
TIMELINE = [
    ...
    ("2020", "The website launches (August 22) and the first Techspressionist Virtual Salon is held on Zoom (September 1). The Visual Artists Index begins in October."),
...
def build():
    ...
    return f"""<!-- Page: What is Techspressionism?   Suggested address: {PAGE}
     SEO title: What is Techspressionism? Definition, history and manifesto | Techspressionism
     Meta description: {html.escape(DESC)}
     Paste everything below into the page's Text/HTML editor (or a Custom HTML block). Generated by scripts/make-wp-what-is-page.py -->
...
Techspressionism as an art movement, and the same year Goldberg published the first manifesto. In 2020 Goldberg, Oz Van Rosen, Steve Miller, Patrick Lichty and
advisor Helen Harrison formed the artist group that became the Techspressionist community. The <a href="/history/">History</a> page has the full record.</p>
