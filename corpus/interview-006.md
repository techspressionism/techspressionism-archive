...
Um, machinist, which, you know, I, I have, I have. A lot of ties to, um, you know, that, that directly. And so what happens is that, you know, this is, um, there, there are two things is that, um, so. You know, like one thing that I like to do is, I mean, I, I love to work with generative, um, adversarial networks currently. And.
...
Um, and then I started working with these, um, uh, autonomous rovers starting in about early two thousands. Um, because I had met this, um, artist who I'm living now, you know, near name. Um, Roman Brosco when I was living in the twin cities and I would just, I just loved his, his, um, plotter work so much. And, and he kind of encouraged me to kind of like find my own direction with these things. And I found these things and basically what the idea was is that I'd set up an algorithm and this would sense the, you know, the lightness of the paper or sense the, I put boundaries around it and it would just keep using this. This set of. The process is to go back and forth and all that sort of thing. And the biggest piece that I did was this is a 21 by seven piece that, um, I called man machine interface and the red is, is me and all the black is the machine.

And, um, you know, in other words, I've, I've always wondered, you know, what, where am I between the, between the process. Uh, I mean, I've always wondered what, where am I between the process and the red is the machine and my own subjectivity. And what time period was this piece made. This was made in 2003 actually.

Gotcha. Do you still have it? Uh, yeah, it's actually in my storage container in Ohio, actually. So it's, it's rolled up. It's a little crumpled on the sides, but it's, I'll probably slice that off and, and get that up someplace.
...
With those drawing machines back in bowling green when I when when I first got there and you had it sort of in the the lobby I think of the art building and
...
These works available through a gallery or like you know if if the
...
Yep yep yep and then um the other the other thing and that I'll wind up saying that isn't that uh isn't here is that um I've been also working with GANs to work out, try to pull the patterns out of Persian carpets. And this is kind of a NP team project, which is myself and Nagin at Tasabian. And so we're just starting to generate some Jakar.
...
Your teaching and stuff like that yeah yeah right right at that right right the moment I'm teaching at in the mass communication department at winona state university in winona minnesota which is on the beautiful mississippi river uh in the the middle of the cold and you know this is uh where you know um number one I wanted to get back into the united states and nagin and I are you know just kind of setting up our studio here and and you were in abu dhabi for about five years or so I would yeah I was in the uae at various places for about five years and you know worked throughout central asia and eurasia and and the middle east and that sort of thing, but I was based in the UAE. Gotcha. Gotcha.

## Colin Goldberg [53:52](https://www.youtube.com/watch?v=a5h-eBQYrks&t=3232s)

All right. Well, I guess, um, I know you mentioned you had to take off around four. Um, so, um, is there anything else you wanted to, to bring up?

## Patrick Lichty [54:02](https://www.youtube.com/watch?v=a5h-eBQYrks&t=3242s)

I think we're good for the moment. I think actually, I'm really glad that we had a talk to kind of, uh, had this time to talk a little bit about kind of like the, kind of like the, the, you know, kind of like the thought. Know, that I've been having behind, you know, this whole Techspressionism thing and, you know, and then share some of the work. And, you know, because I, I think, I think to me, I think that there's a very deep impulse, you know, that comes from a lot of deep thought for me over a long period of time that, you know, is, is a, is a longer project, but, you know, to me, it, it fits under this, this notion of, of, of Techspressionism. And I, you know, I'm, I'm glad that, I'm glad that we're doing this project, you know, and I'm glad that actually the thing is, is that it's, it's given me the chance to do this work, you know, that, that comes out of that art historical tradition.
