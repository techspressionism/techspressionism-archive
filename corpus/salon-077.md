...
Well, thank thank you for asking. And this technology is used in science and medicine as well as surveillance and politics. Because, you know, you can see things in new ways when they have a 3 dimensional kind of form. I see we have a few more questions here, Cynthia.
...
Okay, because I actually constructed these little landscapes in Petri dishes where I knew what the items were. I would put, say, a sunflower with a rubber ducky. But this surprise was the edge of the sculpture. Which was a kind of glitch in the data which I think teaches us more about how we can extend our ecstatic experience by machine learning. And I have been trying to now, use that in some newer pieces. And it's very difficult to actually repeat. So I am working with my collaborator. And we're trying to make that happen at will.
...
Alright. Well, I guess what we could do is, you know, bring this recording to a close, and we could start recording a new session up, Karen, do you have a question?
...
Now you're inside the cinema on the cinema. I had a problem because the cinema box that I use from Sketch Fab. You can't get through the wall. You can see through the wall, but you can't get through the wall. So I had to Narrow one dimension of the box and then bring in the floor plate so the avatars could come into the room. So there I am, going through the studs of the wall into the theatre. And then it's going to swing back again. I hope this is working okay on Zoom, because I know Zoom doesn't do animation. Well.
...
Because you're literally walking inside a model. Versus building it from the outside, looking in. So then I'm going to go upstairs.

I'm gonna swing you around into the main gallery now in the main gallery. There's artwork on both walls, and one piece of large artwork in each of the greenhouses hanging off the back, but also in each one of the galleries there's one animation. And this is something I'm having trouble with Siberiana getting the animations in. So I would love to be in on that discussion, doing my own. I uploaded directly to Mozilla Hub's server, so I have no trouble. The second gallery to the right of the main gallery right there. One of these is an animation. And there we go.

I'm going to bring you right in.

Getting the numbers on the wall was not easy. I couldn't see them. It took a lot of experimentation. But it gives you an idea. Quick run through of the galleries.
...
What I've been doing is, I've just been going to ChatGPT or Google, and just asking those questions. And it'll come back with the specs.

## Verneda Lights [01:44:42](https://www.youtube.com/watch?v=e58ctMQ-ccc&t=6282s)

Okay? Well, can canber, which I don't use often. Has a way where you can convert a gift to an Mp for. You can convert a gift to a video. You know very quickly. So that should save sometime.
...
For instance, since I since I save the other URL, I'm just gonna include it here as well. So now I have 2 images. But basically, I created a new widget, an image widget. Then I have to figure out where I want to place it. How big I want it? And then there you go.
...
Well. The easiest way to tell Renata Rerenetta is. If I move it around. And in the process of moving it.
...
You see how it's. Yes, I see see back right. I'm gonna try to get close in here to show this is the fun of navigating in a threed space. But A.
...
But to have all these other names and titles and stuff moving around and variable over time will disadvantage you in terms of developing search engine traction.
...
You can do that. And what I often what I often do is you'll see this blue button that says, publish to hubs I'll use. II won't even go to the Hamburger. I'll just go up to here and I'll click on that publish to hubs.
